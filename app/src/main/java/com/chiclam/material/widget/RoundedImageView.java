...
public class RoundedImageView extends ImageView {
    ...
    public static final String TAG = "SRIV";
    ...
    private float mFourCornerRadius = 0.0f;
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mFourCornerRadius = a.getDimensionPixelSize(
                R.styleable.RoundedImageView_sriv_four_corner_radius, 0);
        if (mFourCornerRadius > 0) {
            mLeftTopCornerRadius = mFourCornerRadius;
            mRightTopCornerRadius = mFourCornerRadius;
            mLeftBottomCornerRadius = mFourCornerRadius;
            mRightBottomCornerRadius = mFourCornerRadius;
        } else {
    ...
    static class SelectableRoundedCornerDrawable extends Drawable {
        ...
        private static final String TAG = "SRCD";
        private static final int DEFAULT_BORDER_COLOR = Color.BLACK;
